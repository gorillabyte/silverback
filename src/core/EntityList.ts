...
module silverback.core {
	...
	export class EntityList {
	    ...
	    public head: silverback.core.Entity;
	    public tail: silverback.core.Entity;
        		
        public add(entity: silverback.core.Entity ) {
			if( ! this.head ) {
        ...
        public remove(entity: silverback.core.Entity ) {
		    if (this.head === entity) {
		...
		private _removeAll() {
		    while (this.head) {
		        var entity: silverback.core.Entity = this.head;
				this.head = this.head.next;
