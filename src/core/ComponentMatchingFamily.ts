...
module silverback.core {
	 ...
	 */
    export class ComponentMatchingFamily implements silverback.core.IFamily {
        private _nodes: silverback.core.NodeList;
        private _entities: silverback.utils.Dictionary;
		private _nodeClass;
		private _components: silverback.utils.Dictionary;
		private _nodePool: silverback.core.NodePool;
		private _engine: silverback.core.Engine;
		 ...
		 */
		constructor(nodeClass, engine: silverback.core.Engine ) {
		 ...
		 */
		public get nodeList():silverback.core.NodeList {
			return this._nodes;
		}
		 ...
		 */
		public newEntity(entity: silverback.core.Entity) {
		 ...
		 */
		public componentAddedToEntity(entity: silverback.core.Entity, componentClass: () => any  ) {
		    this.addIfMatch( entity );
		}
		 ...
		 * remove it if so.
		 */
		public componentRemovedFromEntity(entity: silverback.core.Entity, componentClass: () => any  ) {
		 ...
		 */
		public removeEntity(entity: silverback.core.Entity ) {
			this.removeIfMatch( entity );
		}
		 ...
		 */
		public addIfMatch(entity: silverback.core.Entity ) {
		 ...
		 */
		public removeIfMatch(entity: silverback.core.Entity ) {
		    if (this._entities.getValue(entity)) {
		        var node: silverback.core.Node = this._entities.getValue(entity);
		 ...
		 */
		public cleanUp() {
		    for (var node: silverback.core.Node = this._nodes.head; node; node = node.next ) {
